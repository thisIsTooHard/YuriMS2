...
var closeTime = 4 * 60 * 1000; //[30 seconds] The time to close the gate
var beginTime = 5 * 60 * 1000; //[30 seconds] The time to begin the ride
var rideTime = 60 * 1000; //[30 seconds] The time that require move to destination
var KC_Waiting;
var Subway_to_KC;
var KC_docked;
var NLC_Waiting;
